package cn.iocoder.linhai.module.system.service.user;

import cn.hutool.core.util.RandomUtil;
import cn.iocoder.linhai.framework.common.enums.CommonStatusEnum;
import cn.iocoder.linhai.framework.common.exception.ServiceException;
import cn.iocoder.linhai.framework.common.pojo.PageResult;
import cn.iocoder.linhai.framework.common.util.collection.ArrayUtils;
import cn.iocoder.linhai.framework.common.util.collection.CollectionUtils;
import cn.iocoder.linhai.framework.test.core.ut.BaseDbUnitTest;
import cn.iocoder.linhai.module.infra.api.config.ConfigApi;
import cn.iocoder.linhai.module.infra.api.file.FileApi;
import cn.iocoder.linhai.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import cn.iocoder.linhai.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import cn.iocoder.linhai.module.system.controller.admin.user.vo.user.UserImportExcelVO;
import cn.iocoder.linhai.module.system.controller.admin.user.vo.user.UserImportRespVO;
import cn.iocoder.linhai.module.system.controller.admin.user.vo.user.UserPageReqVO;
import cn.iocoder.linhai.module.system.controller.admin.user.vo.user.UserSaveReqVO;
import cn.iocoder.linhai.module.system.dal.dataobject.dept.DeptDO;
import cn.iocoder.linhai.module.system.dal.dataobject.dept.PostDO;
import cn.iocoder.linhai.module.system.dal.dataobject.dept.UserPostDO;
import cn.iocoder.linhai.module.system.dal.dataobject.tenant.TenantDO;
import cn.iocoder.linhai.module.system.dal.dataobject.user.AdminUserDO;
import cn.iocoder.linhai.module.system.dal.mysql.dept.UserPostMapper;
import cn.iocoder.linhai.module.system.dal.mysql.user.AdminUserMapper;
import cn.iocoder.linhai.module.system.enums.common.SexEnum;
import cn.iocoder.linhai.module.system.service.dept.DeptService;
import cn.iocoder.linhai.module.system.service.dept.PostService;
import cn.iocoder.linhai.module.system.service.oauth2.OAuth2TokenService;
import cn.iocoder.linhai.module.system.service.permission.PermissionService;
import cn.iocoder.linhai.module.system.service.tenant.TenantService;
...
import static cn.iocoder.linhai.framework.common.util.collection.SetUtils.asSet;
import static cn.iocoder.linhai.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
import static cn.iocoder.linhai.framework.common.util.date.LocalDateTimeUtils.buildTime;
import static cn.iocoder.linhai.framework.common.util.object.ObjectUtils.cloneIgnoreId;
import static cn.iocoder.linhai.framework.test.core.util.AssertUtils.assertPojoEquals;
import static cn.iocoder.linhai.framework.test.core.util.AssertUtils.assertServiceException;
import static cn.iocoder.linhai.framework.test.core.util.RandomUtils.*;
import static cn.iocoder.linhai.module.system.enums.ErrorCodeConstants.*;
import static cn.iocoder.linhai.module.system.service.user.AdminUserServiceImpl.USER_INIT_PASSWORD_KEY;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void before() {
        // mock 初始化密码
        when(configApi.getConfigValueByKey(USER_INIT_PASSWORD_KEY)).thenReturn("linhaiyuanma");
    }
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("linhaiyuanma");
        ...
        assertEquals("linhaiyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("linhaiyuanma"))).thenReturn("java");
