package cn.iocoder.linhai.module.system.service.social;
...
import cn.iocoder.linhai.framework.common.util.cache.CacheUtils;
import cn.iocoder.linhai.framework.common.util.http.HttpUtils;
import cn.iocoder.linhai.framework.common.util.object.BeanUtils;
import cn.iocoder.linhai.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import cn.iocoder.linhai.module.system.api.social.dto.SocialWxaOrderNotifyConfirmReceiveReqDTO;
...
import cn.iocoder.linhai.module.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import cn.iocoder.linhai.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import cn.iocoder.linhai.module.system.dal.dataobject.social.SocialClientDO;
import cn.iocoder.linhai.module.system.dal.mysql.social.SocialClientMapper;
import cn.iocoder.linhai.module.system.dal.redis.RedisKeyConstants;
import cn.iocoder.linhai.module.system.enums.social.SocialTypeEnum;
import cn.iocoder.linhai.module.system.framework.justauth.core.AuthRequestFactory;
...
import static cn.iocoder.linhai.framework.common.util.date.LocalDateTimeUtils.UTC_MS_WITH_XXX_OFFSET_FORMATTER;
import static cn.iocoder.linhai.framework.common.util.date.LocalDateTimeUtils.toEpochSecond;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${linhai.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${linhai.wxa-subscribe-message.miniprogram-state:formal}")
    ...
    public void uploadWxaOrderShippingInfo(Integer userType, SocialWxaOrderUploadShippingInfoReqDTO reqDTO) {
        ...
        // 对应 ISSUE：https://gitee.com/zhijiantianya/linhai-cloud/pulls/230
