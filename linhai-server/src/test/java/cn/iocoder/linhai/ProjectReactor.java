...
public class ProjectReactor {
    ...
    private static final String ARTIFACT_ID = "linhai";
    private static final String PACKAGE_NAME = "cn.iocoder.linhai";
    private static final String TITLE = "银河";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "cn.iocoder.boot";
        String artifactIdNew = "linhai";
        String packageNameNew = "cn.iocoder.linhai";
        String titleNew = "银河";
