package cn.iocoder.linhai.module.crm.controller.admin.product.vo.product;
...
public class CrmProductRespVO implements VO {
    ...
    @Trans(type = TransType.SIMPLE, targetClassName = "cn.iocoder.linhai.module.system.dal.dataobject.user.AdminUserDO",
