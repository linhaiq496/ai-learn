package cn.iocoder.linhai.module.bpm.service.task;
...
import cn.iocoder.linhai.framework.common.util.collection.CollectionUtils;
import cn.iocoder.linhai.framework.common.util.date.DateUtils;
import cn.iocoder.linhai.framework.common.util.json.JsonUtils;
import cn.iocoder.linhai.framework.common.util.object.ObjectUtils;
import cn.iocoder.linhai.framework.common.util.object.PageUtils;
import cn.iocoder.linhai.framework.datapermission.core.annotation.DataPermission;
import cn.iocoder.linhai.module.bpm.api.task.dto.BpmProcessInstanceCreateReqDTO;
import cn.iocoder.linhai.module.bpm.controller.admin.definition.vo.model.BpmModelMetaInfoVO;
import cn.iocoder.linhai.module.bpm.controller.admin.definition.vo.model.simple.BpmSimpleModelNodeVO;
import cn.iocoder.linhai.module.bpm.controller.admin.task.vo.instance.*;
import cn.iocoder.linhai.module.bpm.controller.admin.task.vo.instance.BpmApprovalDetailRespVO.ActivityNodeTask;
import cn.iocoder.linhai.module.bpm.controller.admin.task.vo.task.BpmTaskRespVO;
import cn.iocoder.linhai.module.bpm.convert.task.BpmProcessInstanceConvert;
import cn.iocoder.linhai.module.bpm.dal.dataobject.definition.BpmProcessDefinitionInfoDO;
import cn.iocoder.linhai.module.bpm.dal.redis.BpmProcessIdRedisDAO;
import cn.iocoder.linhai.module.bpm.enums.ErrorCodeConstants;
import cn.iocoder.linhai.module.bpm.enums.definition.BpmModelTypeEnum;
import cn.iocoder.linhai.module.bpm.enums.definition.BpmSimpleModelNodeTypeEnum;
import cn.iocoder.linhai.module.bpm.enums.task.BpmProcessInstanceStatusEnum;
import cn.iocoder.linhai.module.bpm.enums.task.BpmReasonEnum;
import cn.iocoder.linhai.module.bpm.enums.task.BpmTaskStatusEnum;
import cn.iocoder.linhai.module.bpm.framework.flowable.core.candidate.BpmTaskCandidateInvoker;
import cn.iocoder.linhai.module.bpm.framework.flowable.core.enums.BpmTaskCandidateStrategyEnum;
import cn.iocoder.linhai.module.bpm.framework.flowable.core.enums.BpmnModelConstants;
import cn.iocoder.linhai.module.bpm.framework.flowable.core.enums.BpmnVariableConstants;
import cn.iocoder.linhai.module.bpm.framework.flowable.core.event.BpmProcessInstanceEventPublisher;
import cn.iocoder.linhai.module.bpm.framework.flowable.core.util.BpmHttpRequestUtils;
import cn.iocoder.linhai.module.bpm.framework.flowable.core.util.BpmnModelUtils;
import cn.iocoder.linhai.module.bpm.framework.flowable.core.util.FlowableUtils;
import cn.iocoder.linhai.module.bpm.framework.flowable.core.util.SimpleModelUtils;
import cn.iocoder.linhai.module.bpm.service.definition.BpmProcessDefinitionService;
import cn.iocoder.linhai.module.bpm.service.message.BpmMessageService;
import cn.iocoder.linhai.module.system.api.dept.DeptApi;
import cn.iocoder.linhai.module.system.api.dept.dto.DeptRespDTO;
import cn.iocoder.linhai.module.system.api.user.AdminUserApi;
import cn.iocoder.linhai.module.system.api.user.dto.AdminUserRespDTO;
...
import static cn.iocoder.linhai.module.bpm.controller.admin.task.vo.instance.BpmApprovalDetailRespVO.ActivityNode;
import static cn.iocoder.linhai.module.bpm.enums.ErrorCodeConstants.*;
import static cn.iocoder.linhai.module.bpm.framework.flowable.core.enums.BpmnModelConstants.START_USER_NODE_ID;
import static cn.iocoder.linhai.module.bpm.framework.flowable.core.util.BpmnModelUtils.parseNodeType;
...
public class BpmProcessInstanceServiceImpl implements BpmProcessInstanceService {
    ...
    @DataPermission(enable = false) // 关闭数据权限，避免查询不到用户数据。相关案例：https://gitee.com/zhijiantianya/linhai-cloud/issues/ID1UYA
