package cn.iocoder.linhai.module.iot.core.messagebus.config;

import cn.iocoder.linhai.framework.mq.redis.core.RedisMQTemplate;
import cn.iocoder.linhai.framework.mq.redis.core.job.RedisPendingMessageResendJob;
import cn.iocoder.linhai.framework.mq.redis.core.job.RedisStreamMessageCleanupJob;
...
import cn.iocoder.linhai.module.iot.core.messagebus.core.local.IotLocalMessageBus;
import cn.iocoder.linhai.module.iot.core.messagebus.core.redis.IotRedisMessageBus;
import cn.iocoder.linhai.module.iot.core.messagebus.core.rocketmq.IotRocketMQMessageBus;
...
public class IotMessageBusAutoConfiguration {
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "linhai.iot.message-bus", name = "type", havingValue = "local", matchIfMissing = true)
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "linhai.iot.message-bus", name = "type", havingValue = "rocketmq")
    ...
    /**
     * 特殊：由于 LinhaiRedisMQConsumerAutoConfiguration 关于 Redis stream 的消费是动态注册，所以这里只能拷贝相关的逻辑！！！
     *
     * @see cn.iocoder.linhai.framework.mq.redis.config.LinhaiRedisMQConsumerAutoConfiguration
     */
    @Configuration
    @ConditionalOnProperty(prefix = "linhai.iot.message-bus", name = "type", havingValue = "redis")
