package cn.iocoder.linhai.module.iot.job.device;
...
import cn.iocoder.linhai.module.iot.framework.iot.config.LinhaiIotProperties;
...
public class IotDeviceOfflineCheckJob implements JobHandler {
    ...
    @Resource
    private LinhaiIotProperties iotProperties;
