...
import cn.iocoder.linhai.framework.common.util.date.LocalDateTimeUtils;
...
import cn.iocoder.linhai.module.pay.framework.pay.core.client.dto.order.PayOrderUnifiedReqDTO;
...
import cn.iocoder.linhai.module.pay.convert.order.PayOrderConvert;
    ...
    public PayOrderSubmitRespVO submitOrder(PayOrderSubmitReqVO reqVO, String userIp) {
        ...
        if (unifiedOrderResp != null) {
            try {
                ...
                // 兼容 https://gitee.com/zhijiantianya/linhai-cloud/issues/I8SM9H 场景
