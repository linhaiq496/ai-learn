package cn.iocoder.linhai.module.mes.dal.mysql.wm.productsales;
...
public interface MesWmProductSalesLineMapper extends BaseMapperX<MesWmProductSalesLineDO> {
    ...
    default cn.iocoder.linhai.framework.common.pojo.PageResult<MesWmProductSalesLineDO> selectPage(
            cn.iocoder.linhai.module.mes.controller.admin.wm.productsales.vo.line.MesWmProductSalesLinePageReqVO reqVO) {
        return selectPage(reqVO, new cn.iocoder.linhai.framework.mybatis.core.query.LambdaQueryWrapperX<MesWmProductSalesLineDO>()
