...
import cn.iocoder.linhai.module.mes.controller.admin.pro.task.vo.MesProTaskIssuePageReqVO;
import cn.iocoder.linhai.module.mes.controller.admin.pro.task.vo.MesProTaskIssueRespVO;
import cn.iocoder.linhai.module.mes.controller.admin.pro.task.vo.MesProTaskIssueSaveReqVO;
...
import cn.iocoder.linhai.module.mes.dal.dataobject.pro.task.MesProTaskIssueDO;
...
import cn.iocoder.linhai.module.mes.service.pro.task.MesProTaskIssueService;
...
public class MesProTaskIssueController {
    ...
    private List<MesProTaskIssueRespVO> buildIssueRespVOList(List<MesProTaskIssueDO> list) {
        ...
        // 拼接 VO
        return cn.iocoder.linhai.framework.common.util.collection.CollectionUtils.convertList(list, issue -> {
