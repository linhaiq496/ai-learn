package cn.iocoder.linhai.module.ai.service.chat;
...
import cn.iocoder.linhai.module.ai.controller.admin.chat.vo.message.AiChatMessagePageReqVO;
import cn.iocoder.linhai.module.ai.controller.admin.chat.vo.message.AiChatMessageRespVO;
...
import cn.iocoder.linhai.module.ai.dal.dataobject.chat.AiChatConversationDO;
...
import cn.iocoder.linhai.module.ai.dal.mysql.chat.AiChatMessageMapper;
import cn.iocoder.linhai.module.ai.enums.ErrorCodeConstants;
...
import cn.iocoder.linhai.module.ai.service.knowledge.AiKnowledgeDocumentService;
import cn.iocoder.linhai.module.ai.service.knowledge.AiKnowledgeSegmentService;
import cn.iocoder.linhai.module.ai.service.knowledge.bo.AiKnowledgeSegmentSearchReqBO;
import cn.iocoder.linhai.module.ai.service.knowledge.bo.AiKnowledgeSegmentSearchRespBO;
...
import static cn.iocoder.linhai.framework.common.pojo.CommonResult.error;
...
import static cn.iocoder.linhai.module.ai.enums.ErrorCodeConstants.CHAT_CONVERSATION_NOT_EXISTS;
import static cn.iocoder.linhai.module.ai.enums.ErrorCodeConstants.CHAT_MESSAGE_NOT_EXIST;
...
public class AiChatMessageServiceImpl implements AiChatMessageService {
    ...
    @Autowired(required = false) // 由于 linhai.ai.web-search.enable 配置项，可以关闭 AiWebSearchClient 的功能，所以这里只能不强制注入
    private AiWebSearchClient webSearchClient;

    @SuppressWarnings("SpringJavaAutowiredFieldsWarningInspection")
    @Autowired(required = false) // 由于 linhai.ai.mcp.client.enable 配置项，可以关闭 McpSyncClient 的功能，所以这里只能不强制注入
