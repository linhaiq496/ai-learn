package cn.iocoder.linhai.module.ai.framework.ai.core.model;
...
import cn.iocoder.linhai.framework.common.util.spring.SpringUtils;
import cn.iocoder.linhai.module.ai.enums.model.AiPlatformEnum;
import cn.iocoder.linhai.module.ai.framework.ai.config.AiAutoConfiguration;
import cn.iocoder.linhai.module.ai.framework.ai.config.LinhaiAiProperties;
...
import cn.iocoder.linhai.module.ai.framework.ai.core.model.siliconflow.SiliconFlowImageApi;
import cn.iocoder.linhai.module.ai.framework.ai.core.model.siliconflow.SiliconFlowImageModel;
...
public class AiModelFactoryImpl implements AiModelFactory {
    ...
    public MidjourneyApi getOrCreateMidjourneyApi(String apiKey, String url) {
        ...
        return Singleton.get(cacheKey, (Func0<MidjourneyApi>) () -> {
            LinhaiAiProperties.Midjourney properties = SpringUtil.getBean(LinhaiAiProperties.class)
                    .getMidjourney();
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#douBaoChatClient(LinhaiAiProperties)}
     */
    private ChatModel buildDouBaoChatModel(String apiKey) {
        LinhaiAiProperties.DouBao properties = new LinhaiAiProperties.DouBao()
                .setApiKey(apiKey);
        return new AiAutoConfiguration().buildDouBaoChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#hunYuanChatClient(LinhaiAiProperties)}
     */
    private ChatModel buildHunYuanChatModel(String apiKey, String url) {
        LinhaiAiProperties.HunYuan properties = new LinhaiAiProperties.HunYuan()
                .setBaseUrl(url).setApiKey(apiKey);
        return new AiAutoConfiguration().buildHunYuanChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#siliconFlowChatClient(LinhaiAiProperties)}
     */
    private ChatModel buildSiliconFlowChatModel(String apiKey) {
        LinhaiAiProperties.SiliconFlow properties = new LinhaiAiProperties.SiliconFlow()
                .setApiKey(apiKey);
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#xingHuoChatClient(LinhaiAiProperties)}
     */
    private static XingHuoChatModel buildXingHuoChatModel(String key) {
        ...
        LinhaiAiProperties.XingHuo properties = new LinhaiAiProperties.XingHuo()
                .setAppKey(keys.get(0)).setSecretKey(keys.get(1));
        return new AiAutoConfiguration().buildXingHuoChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#baiChuanChatClient(LinhaiAiProperties)}
     */
    private BaiChuanChatModel buildBaiChuanChatModel(String apiKey) {
        LinhaiAiProperties.BaiChuan properties = new LinhaiAiProperties.BaiChuan()
                .setApiKey(apiKey);
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#buildGeminiChatClient(LinhaiAiProperties.Gemini)}
     */
    private static GeminiChatModel buildGeminiChatModel(String apiKey) {
        LinhaiAiProperties.Gemini properties = SpringUtil.getBean(LinhaiAiProperties.class)
    ...
    private ChatModel buildGrokChatModel(String apiKey,String url) {
        LinhaiAiProperties.Grok properties = new LinhaiAiProperties.Grok()
                .setBaseUrl(url)
                .setApiKey(apiKey);
