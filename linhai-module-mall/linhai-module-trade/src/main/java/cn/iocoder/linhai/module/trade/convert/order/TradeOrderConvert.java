package cn.iocoder.linhai.module.trade.convert.order;
...
import cn.iocoder.linhai.framework.common.util.string.StrUtils;
import cn.iocoder.linhai.framework.dict.core.DictFrameworkUtils;
import cn.iocoder.linhai.framework.ip.core.utils.AreaUtils;
import cn.iocoder.linhai.module.member.api.address.dto.MemberAddressRespDTO;
import cn.iocoder.linhai.module.member.api.user.dto.MemberUserRespDTO;
import cn.iocoder.linhai.module.pay.api.order.dto.PayOrderCreateReqDTO;
import cn.iocoder.linhai.module.pay.enums.DictTypeConstants;
import cn.iocoder.linhai.module.product.api.comment.dto.ProductCommentCreateReqDTO;
import cn.iocoder.linhai.module.product.api.property.dto.ProductPropertyValueDetailRespDTO;
import cn.iocoder.linhai.module.product.api.sku.dto.ProductSkuRespDTO;
import cn.iocoder.linhai.module.product.api.sku.dto.ProductSkuUpdateStockReqDTO;
import cn.iocoder.linhai.module.product.api.spu.dto.ProductSpuRespDTO;
import cn.iocoder.linhai.module.promotion.api.combination.dto.CombinationRecordCreateReqDTO;
import cn.iocoder.linhai.module.trade.api.order.dto.TradeOrderRespDTO;
import cn.iocoder.linhai.module.trade.controller.admin.base.member.user.MemberUserRespVO;
import cn.iocoder.linhai.module.trade.controller.admin.base.product.property.ProductPropertyValueDetailRespVO;
import cn.iocoder.linhai.module.trade.controller.admin.order.vo.*;
import cn.iocoder.linhai.module.trade.controller.app.base.property.AppProductPropertyValueDetailRespVO;
import cn.iocoder.linhai.module.trade.controller.app.order.vo.*;
import cn.iocoder.linhai.module.trade.controller.app.order.vo.item.AppTradeOrderItemCommentCreateReqVO;
import cn.iocoder.linhai.module.trade.controller.app.order.vo.item.AppTradeOrderItemRespVO;
...
import cn.iocoder.linhai.module.trade.dal.dataobject.order.TradeOrderLogDO;
import cn.iocoder.linhai.module.trade.enums.order.TradeOrderItemAfterSaleStatusEnum;
import cn.iocoder.linhai.module.trade.framework.delivery.core.client.dto.ExpressTrackRespDTO;
import cn.iocoder.linhai.module.trade.framework.order.config.TradeOrderProperties;
import cn.iocoder.linhai.module.trade.service.brokerage.bo.BrokerageAddReqBO;
...
import static cn.iocoder.linhai.framework.common.util.collection.CollectionUtils.convertMap;
import static cn.iocoder.linhai.framework.common.util.collection.CollectionUtils.convertMultiMap;
import static cn.iocoder.linhai.framework.common.util.date.LocalDateTimeUtils.addTime;
...
public interface TradeOrderConvert {
    ...
    default BrokerageAddReqBO convert(MemberUserRespDTO user, TradeOrderItemDO item,
        ...
        if (BooleanUtil.isTrue(spu.getSubCommissionType())) {
            // 特殊：单独设置的佣金需要乘以购买数量。关联 https://gitee.com/linhaicode/linhai-mall-uniapp/issues/ICY7SJ
