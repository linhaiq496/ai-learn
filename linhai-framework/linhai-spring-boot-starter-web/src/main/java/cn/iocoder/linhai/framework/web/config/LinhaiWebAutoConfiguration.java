package cn.iocoder.linhai.framework.web.config;
...
import cn.iocoder.linhai.framework.web.core.filter.CacheRequestBodyFilter;
import cn.iocoder.linhai.framework.web.core.filter.DemoFilter;
import cn.iocoder.linhai.framework.web.core.handler.GlobalExceptionHandler;
import cn.iocoder.linhai.framework.web.core.handler.GlobalResponseBodyHandler;
...
public class LinhaiWebAutoConfiguration {
     ...
     */
    @Bean
    @ConditionalOnProperty(value = "linhai.demo", havingValue = "true")
