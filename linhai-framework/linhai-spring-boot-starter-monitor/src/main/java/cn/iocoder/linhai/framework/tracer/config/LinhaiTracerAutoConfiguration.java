...
import cn.iocoder.linhai.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "linhai.tracer", value = "enable", matchIfMissing = true)
public class LinhaiTracerAutoConfiguration {
