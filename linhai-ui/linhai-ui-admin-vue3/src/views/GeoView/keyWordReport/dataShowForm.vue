  ...
  <div class="main">
    <div class="header_search">
      <div class="header_left">
        <el-input placeholder="搜索" v-model="searchVo.keyword" class="header_input"
                  :suffix-icon="Search" @keydown.enter="initDataList"/>
      </div>
      <div class="header_right">
        <span class="header_update_time">更新时间：2022-03-01 10:00:00</span>
        <div class="header_btn" @click="_emit('lookDataDetail')">数据报表</div>
      </div>
    </div>
    ...
    <div class="show_place">
      <el-table
        ...
        <el-table-column prop="extendedWords" label="扩展词" width="450px"/>
