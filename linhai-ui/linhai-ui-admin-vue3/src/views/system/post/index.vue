<template>
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list" @selection-change="handleRowCheckboxChange">
      ...
      <el-table-column label="行业编号" align="center" prop="id" />
      <el-table-column label="行业名称" align="center" prop="name" />
      <el-table-column label="行业编码" align="center" prop="code" />
      <el-table-column label="行业顺序" align="center" prop="sort" />
      <el-table-column label="行业备注" align="center" prop="remark" />
