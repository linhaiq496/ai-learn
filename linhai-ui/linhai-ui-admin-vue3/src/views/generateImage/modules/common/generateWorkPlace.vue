...
async function generateImage() {
  ...
  try {
    ...
    const params = {
      ...
      // closeUpImageCount: r.featuresImages,1
...
$form_item_width2: calc((100vw - 20px - var(--left-menu-max-width) - var(--app-content-padding)) * 542 / 1679 - 40px);
