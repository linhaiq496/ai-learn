  ...
  const renderClassic = () => {
    return (
      <>
        <div
          class={[
            'absolute top-0 left-0 h-full flex flex-col',
        ...
        >
          ...
          <div
            class={[
              'h-56px flex items-center bg-[var(--left-menu-bg-color)]',
              {
                'justify-center w-[var(--left-menu-min-width)]': appStore.getCollapse,
                'justify-center w-[var(--left-menu-max-width)] px-20px': !appStore.getCollapse
              }
            ]}
          >
            <UserInfo></UserInfo>
